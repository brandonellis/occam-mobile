export const colors = {
  // Primary — matches occam-client charcoal
  primary: '#191E24',
  primaryLight: '#212529',
  primaryDark: '#111418',
  ...
  // Aqua — matches occam-client primary aqua
  aqua: '#59D8DB',
  aquaLight: '#8EE7E9',
  ...
  // Neutrals — matches occam-client gray scale
  white: '#FFFFFF',
  background: '#F8F9FA',
  surface: '#FFFFFF',
  border: '#E9ECEF',
  ...
  // Gray scale — full set from occam-client
  gray50: '#F8F9FA',
  gray100: '#F1F3F5',
  gray200: '#E9ECEF',
  gray300: '#DEE2E6',
  ...
  // Dark surfaces — video/camera/recording screens
  black: '#000000',
  darkSurface: '#111111',
  darkText: '#999999',

  // Inverse text variants — for dark backgrounds
  textInverseDisabled: 'rgba(255, 255, 255, 0.3)',
  textInverseHint: 'rgba(255, 255, 255, 0.4)',
  textInverseSubdued: 'rgba(255, 255, 255, 0.45)',
  ...
  // Surfaces — dark themed
  dropdownSurface: 'rgba(33, 37, 41, 0.98)',
};
